    ...
    for Species in ['AB42']:
        for Comp in ['BrainISF']:
            ...
            for fibril in ['FibrilMass','PlaqueMass']:
                ...
                Reactants = f"[0.9 {Species}_{Comp},{Species}_{fibril}_{Comp}]"
                Products = f"[{Species}_Oligomer_{Comp}]"
                Rate_type = "custom"
                Rate_eqtn_prototype = f"k_oligo2_{Species} * ({Species}_{Comp})^n_oligo2_{Species} * {Species}_{fibril}_{Comp} * V_{Comp}"
                Reaction_dict = {"Reaction_name": Reaction_name,"Reactants": Reactants,"Products": Products,"Rate_type": Rate_type,"Rate_eqtn_prototype": Rate_eqtn_prototype,} 
                all_reactions.append(Reaction_dict)
            ...
            Products = f"[0]"
            Rate_type = "MA"
            Rate_eqtn_prototype = f"Microglia*(Hi_lo_ratio*Microglia_high_frac*Microglia_Vmax_AB42/(Microglia_EC50_AB42 + (AB42_FibrilMass_BrainISF/V_BrainISF)) + (1.0 - Microglia_high_frac)*Microglia_Vmax_AB42/(Microglia_EC50_AB42 + (AB42_FibrilMass_BrainISF/V_BrainISF)))"
            Reaction_dict = {"Reaction_name": Reaction_name,"Reactants": Reactants,"Products": Products,"Rate_type": Rate_type,"Rate_eqtn_prototype": Rate_eqtn_prototype,}
            all_reactions.append(Reaction_dict)
            ...
            Products = f"[0]"
            Rate_type = "MA"
            Rate_eqtn_prototype = f"Microglia*Hi_lo_ratio*Microglia_Vmax_{Species}/(Microglia_EC50_{Species} + {Species}_PlaqueMass_{Comp})"            
            Reaction_dict = {"Reaction_name": Reaction_name,"Reactants": Reactants,"Products": Products,"Rate_type": Rate_type,"Rate_eqtn_prototype": Rate_eqtn_prototype,}
            all_reactions.append(Reaction_dict)
            ...
            Products = f"[0]"
            Rate_type = "custom"
            Rate_eqtn_prototype = f"Microglia/Plaque_degree_polymerization*Hi_lo_ratio*Microglia_Vmax_{Species}/(Microglia_EC50_{Species} + {Species}_PlaqueMass_{Comp}) * AB42_PlaqueMass_BrainISF * V_BrainISF"            
            Reaction_dict = {"Reaction_name": Reaction_name,"Reactants": Reactants,"Products": Products,"Rate_type": Rate_type,"Rate_eqtn_prototype": Rate_eqtn_prototype,}
            all_reactions.append(Reaction_dict)
            ...
            Rate_type = "MA"
            Rate_eqtn_prototype = f"k_plaque * (Fibril_degree_polymerization/(Fibril_degree_polymerization+Plaque_EC50))"            
            Reaction_dict = {"Reaction_name": Reaction_name,"Reactants": Reactants,"Products": Products,"Rate_type": Rate_type,"Rate_eqtn_prototype": Rate_eqtn_prototype,}
            all_reactions.append(Reaction_dict)

            counter += 1
            Reaction_name = f"FibrilNumber to PlaqueNumber"
            Reactants = f"[{Species}_FibrilNumber_{Comp}]"
            Products = f"[{Species}_PlaqueNumber_{Comp}]"
            Rate_type = "custom"
            Rate_eqtn_prototype = f"k_plaque/Fibril_degree_polymerization * (Fibril_degree_polymerization/(Fibril_degree_polymerization+Plaque_EC50)) * AB42_FibrilMass_BrainISF  * V_BrainISF"            
            Reaction_dict = {"Reaction_name": Reaction_name,"Reactants": Reactants,"Products": Products,"Rate_type": Rate_type,"Rate_eqtn_prototype": Rate_eqtn_prototype,}
            all_reactions.append(Reaction_dict)
    print(counter)
