...
def run_simulation():
    ...
    result = r.simulate(0, 70*365*24, 100000)
    # result = r.simulate(1000, 200000, 200000)
    result = r.simulate(70*365*24, 1000000, 3000000, ['time','[Antibody_Plasma]','[Antibody_BrainISF]','[Antibody_LiverVascular]',
    ...
    # ax1.plot(result['time']/24/365, result['Anti_ABeta_ISF_sum'], label='Total_Antibody_BrainISF',color='purple')
