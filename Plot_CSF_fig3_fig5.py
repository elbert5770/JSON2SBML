...
fig5_CSF_placebo = fig5_CSF_placebo.sort_values(by='time')
fig5_CSF_placebo_data = fig5_CSF_placebo_data.sort_values(by='time')
...
# Plot Figure 5 data
plt.plot(fig5_CSF_placebo['time']+0.3, fig5_CSF_placebo['measurement'], 'k-', label='Figure 7 SUVR Placebo')
plt.plot(fig5_CSF_placebo_data['time']+0.3, fig5_CSF_placebo_data['measurement'], 'ko', label='Figure 7 SUVR Placebo Data')

# Plot original Figure 3 data
plt.plot(fig3_CSF_APOE4['time'], fig3_CSF_APOE4['measurement'], 'rx', label='Figure 3 CSF APOE4 (original)')
plt.plot(fig3_CSF_nonAPOE4['time'], fig3_CSF_nonAPOE4['measurement'], 'bx', label='Figure 3 CSF non-APOE4 (original)')
