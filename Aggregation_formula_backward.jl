...
function main()
    ...
    for i in 1:24
        Final_40[i] = calculate_aggregation_rates(i,kb0_40,kb1_40,Asymp_40,Hill_40)
        Final_42[i] = calculate_aggregation_rates(i,kb0_42,kb1_42,Asymp_42,Hill_42)
        # @show i,Final_40, Final_42,KF40/(i^Hill_40+KF40),KF42/(i^Hill_42+KF42)
        Final_40_Hill[i] = calculate_aggregation_rates_Hill(i,kb0_40,kb1_40,Asymp_40,Hill_40)
        Final_42_Hill[i] = calculate_aggregation_rates_Hill(i,kb0_42,kb1_42,Asymp_42,Hill_42)
        Final_40_new[i] = calculate_aggregation_rates_new(i,kb0_40,kb1_40,Asymp_40,Hill_40)
        Final_42_new[i] = calculate_aggregation_rates_new(i,kb0_42,kb1_42,Asymp_42,Hill_42)
        # @show i,Final_40_new, Final_42_new,KF40new/(i^Hill_40+KF40new),KF42new/(i^Hill_42+KF42new)
        Final_40_new_Hill[i] = calculate_aggregation_rates_new_Hill(i,kb0_40,kb1_40,Asymp_40,Hill_40)
        Final_42_new_Hill[i] = calculate_aggregation_rates_new_Hill(i,kb0_42,kb1_42,Asymp_42,Hill_42)
        KF42 = (kb1_42 - Asymp_42*kb1_42)/(kb0_42 - kb1_42)
        KF42new = (kb0_42 - Asymp_42*kb1_42)/(kb0_42 - kb1_42)
        @show i,KF42,KF42new
    end
    ...
    hline!([kb0_42],label="kf0")
    hline!([kb1_42],label="kf1")
