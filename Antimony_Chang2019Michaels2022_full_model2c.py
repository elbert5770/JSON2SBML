...
def run_simulation():
    ...
    result = r.simulate(200000, 1000000, 1300000, ['time','[Antibody_Plasma]','[Antibody_BrainISF]','[Antibody_LiverVascular]',
    ...
    '[AB42_Plasma]','[AB42_SAS]','Fibril_degree_polymerization'])
    ...
    ax3.plot(result['time']/24/365, result['Fibril_degree_polymerization'], label='Fibril degree of polymerization')
    ax3.set_xlabel('Time (years)')
    ax3.set_ylabel('Dimensionless')
    ax3.set_title('Panel 3: Fibril Molecular Weight')
    ax3.legend()
