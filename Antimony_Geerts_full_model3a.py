...
def run_optimization_and_simulation(Antibody_name):
    ...
    if Antibody_name == 'Gantenerumab':
        ...
        fa0 = 7.87402e-06
        fa1 = 0.0003257329
        fa2 = 0.0039840637450199
        fa3 = 0.0144927536231884
        Vcent = 19.6858
        Vper = 1.0
        SC_DoseAmount = 2050.6
        IV_DoseAmount = 0.0
    elif Antibody_name == 'Lecanemab':
        CLd2 = 0.035
        CL = 0.0191
        SC_bio = 1
        SC_ka = 1
...
if __name__ == "__main__":
    ...
    results = run_optimization_and_simulation(Antibody_name='Gantenerumab')
