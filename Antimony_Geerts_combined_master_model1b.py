...
def create_plots(r, result1, result2, csv_data_3C_ApoE, csv_data_3C_nonApoE, csv_data_3A_ApoE, csv_data_3A_nonApoE, suvr):
    ...
    # ax5 = axes[2, 0]
    # ax5.plot(time_years1, result1['[CL_AB42_IDE]'], label='IDE_activity_ISF ApoE', linewidth=2,color='red')
    # ax5.plot(time_years2, result2['[CL_AB42_IDE]'], label='IDE_activity_ISF non-ApoE', linewidth=2,color='blue')
