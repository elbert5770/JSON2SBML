...
def run_simulation():
    ...
    ax1.plot(result['time'], result['[AB42_BrainISF]'], label='AB42_BrainISF')
    ax1.plot(result['time'], result['[Antibody_BrainISF]'], label='Antibody_BrainISF')
    ax1.plot(result['time'], result['[AB42_Plasma]'], label='AB42_Plasma')
    ...
    ax2.plot(result['time'], result['AB42_Oligomer_BrainISF'], label='AB42_Oligomer_BrainISF')
    ax2.plot(result['time'], result['[AB42_FibrilNumber_BrainISF]'], label='AB42_FibrilNumber_BrainISF')
    ax2.plot(result['time'], result['[AB42_FibrilMass_BrainISF]'], label='AB42_FibrilMass_BrainISF')
    ax2.set_xlabel('Time')
