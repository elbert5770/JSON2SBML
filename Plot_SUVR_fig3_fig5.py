...
# Plot Figure 5 data
plt.plot(fig5_SUVR_placebo['time']+0.3, fig5_SUVR_placebo['measurement'], marker='o', linestyle='-', label='Figure 5 SUVR Placebo')
plt.plot(fig5_SUVR_placebo_data['time']+0.3, fig5_SUVR_placebo_data['measurement'], marker='o', label='Figure 5 SUVR Placebo Data')
