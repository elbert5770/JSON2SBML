...
def run_optimization_and_simulation():
    ...
    def create_objective(csv_data_3C_ApoE, csv_data_3C_nonApoE, csv_data_3A_ApoE, csv_data_3A_nonApoE, r, param_names):
        def objective(params):
            ...
            mse1 = mse1 + (suvr_70_results['oligomer_weighted_sum']-12000)**2 / 12000
            mse1 = mse1 + (suvr_70_results['proto_weighted_sum']-70000)**2 / 70000
            ...
            mse2 = mse2 + (suvr_70_results['oligomer_weighted_sum']-12000)**2 / 12000
            mse2 = mse2 + (suvr_70_results['proto_weighted_sum']-70000)**2 / 70000
